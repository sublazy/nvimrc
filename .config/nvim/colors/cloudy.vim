...
if ! exists("g:cloudy_termcolors")
  let g:cloudy_termcolors = 256
endif

" not all terminals support italics properly.  If yours does, opt-in.
if ! exists("g:cloudy_terminal_italics")
  let g:cloudy_terminal_italics = 0
endif
...
let s:blue      = {"gui": "#8CBEF5" , "cterm": "159" , "cterm16": "4"}
let s:blue_d    = {"gui": "#3465a4" , "cterm": "75"  , "cterm16": "12"}
let s:purple    = {"gui": "#EE8FE3" , "cterm": "141" , "cterm16": "5"}
...
let s:cyan_d    = {"gui": "#63B5B7" , "cterm": "121" , "cterm16": "14"}
...
let s:kashmir         = { "gui": "#586A8A", "cterm": "0", "cterm16" : "0" }
let s:kashmir_d       = { "gui": "#4E5E7A", "cterm": "0", "cterm16" : "0" }
let s:kashmir_dd      = { "gui": "#44536B", "cterm": "0", "cterm16" : "0" }
let s:kashmir_ddd     = { "gui": "#3A475C", "cterm": "0", "cterm16" : "0" }
let s:kashmir_dddd    = { "gui": "#303B4D", "cterm": "0", "cterm16" : "0" }

let s:cloud           = { "gui": "#3A475C", "cterm": "0", "cterm16" : "0" }
let s:cloud_d         = { "gui": "#374357", "cterm": "0", "cterm16" : "0" }
let s:cloud_dd        = { "gui": "#343F52", "cterm": "0", "cterm16" : "0" }
let s:cloud_ddd       = { "gui": "#313B4D", "cterm": "0", "cterm16" : "0" }
let s:cloud_dddd      = { "gui": "#2D3747", "cterm": "0", "cterm16" : "0" }
let s:cloud_ddddd     = { "gui": "#272F3D", "cterm": "0", "cterm16" : "0" }
...
let s:lemon          = { "gui": "#DBB100", "cterm": "0", "cterm16" : "0" }
...
let s:bg              = s:cloud
let s:bg_subtle       = s:cloud_d
let s:bg_dark         = s:cloud_dd
let s:dark_d          = s:cloud_dd
let s:norm            = s:bwe0
let s:norm_subtle     = s:bwb0
let s:visual          = s:cloud_ddddd
...
function! s:h(group, style)
  " Not all terminals support italics properly. If yours does, opt-in.
  if g:cloudy_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:cloudy_termcolors == 16
...
call s:h("Comment",       {"fg": s:bw90, "gui": "none", "cterm": "none"})
...
call s:h("Todo",       {"fg": s:bwa0, "bg": s:cloud_dddd, "gui": "bold", "cterm": "bold" })
...
call s:h("Search",        {"bg": s:persian_plum, "fg": s:yellow})
call s:h("MoreMsg",       {"fg": s:bw70, "gui": "bold", "cterm": "bold"})
hi! link ModeMsg MoreMsg
call s:h("LineNr",        {"fg": s:bw70, "bg": s:bg_subtle})
call s:h("CursorLineNr",  {"fg": s:bwa0, "bg": s:cloud_dd})
...
call s:h("VertSplit",     {"fg": s:cloud_dd, "bg": s:cloud_dd})
call s:h("Title",         {"fg": s:blue_d})
call s:h("Visual",        {"bg": s:visual})
call s:h("WarningMsg",    {"fg": s:yellow})
call s:h("WildMenu",      {"fg": s:yellow, "bg": s:bw10})
call s:h("Folded",        {"bg": s:bg_subtle, "fg": s:bw80})
call s:h("FoldColumn",    {"fg": s:bw50, "gui": "bold", "cterm": "bold"})
call s:h("QuickFixLine",  {"bg": s:kashmir_ddd, "gui": "bold", "cterm": "bold"})
...
call s:h("DiffChange" , {"fg": s:norm         , "bg": s:kashmir_ddd})
call s:h("DiffText"   , {"fg": s:yellow       , "bg": s:bw10})

call s:h("diffAdded"     , {"fg": s:green  , "bg": s:bg})
call s:h("diffRemoved"   , {"fg": s:red    , "bg": s:bg})
call s:h("diffFile"      , {"fg": s:yellow , "bg": s:bg})
call s:h("diffIndexLine" , {"fg": s:yellow , "bg": s:bg})
call s:h("diffLine"      , {"fg": s:cyan   , "bg": s:bg})
call s:h("diffSubname"   , {"fg": s:cyan   , "bg": s:bg})
...
call s:h("Pmenu"      , {"fg": s:norm   , "bg": s:cloud_dd})
call s:h("PmenuSel"   , {"fg": s:green , "bg": s:cloud_dddd})
call s:h("PmenuSbar"  , {"bg": s:cloud_ddd})
call s:h("PmenuThumb" , {"bg": s:mirage})

call s:h("TabLine",       {"fg": s:norm, "bg": s:kashmir})
call s:h("TabLineSel",    {"fg": s:yellow, "bg": s:kashmir, "gui": "bold", "cterm": "bold"})
call s:h("TabLineFill",   {"fg": s:norm, "bg": s:kashmir})

call s:h("CursorColumn",  {"bg": s:bg_subtle})
call s:h("CursorLine",    {"bg": s:cloud_dd})
...
call s:h("MatchParen",    {"bg": s:bw20, "fg": s:yellow})
...
" org-mode
call s:h("org_heading1",                {"fg": s:yellow, "gui": "bold", "cterm": "bold"})
call s:h("org_heading2",    {"fg": s:yellow})
call s:h("org_heading3",                  {"fg": s:yellow})
call s:h("org_todo_keyword_DONE",                  {"fg": s:green_d})

" ReStructured Text
call s:h("rstSections",                 {"fg": s:yellow})

" Asciidoc
call s:h("asciidocTwoLineTitle",        {"fg": s:yellow})
call s:h("asciidocListBullet",          {"fg": s:green})
call s:h("asciidocQuotedBold",          {"fg": s:purple})
...
" XML content
call s:h("xmlTag",                {"fg": s:bwa0})
call s:h("xmlTagName",            {"fg": s:cyan_d})
call s:h("xmlEndTag",             {"fg": s:bw80})
call s:h("xmlString",             {"fg": s:lemon})
call s:h("xmlAttrib",             {"fg": s:blue})

" Yaml content
hi! link yamlBlockMappingKey      xmlTagName
hi! link yamlFlowMappingKey       xmlAttrib
hi! link yamlPlainScalar          xmlString
hi! link yamlInteger              yamlPlainScalar
hi! link yamlKeyValueDelimiter    xmlTag
hi! link yamlFlowIndicator        xmlTag
hi! link yamlFlowMapping          xmlTag
hi! link yamlBlockCollectionItemStart xmlTag

call s:h("xmlTag",                {"fg": s:bwa0})
call s:h("xmlTagName",            {"fg": s:cyan_d})
call s:h("xmlEndTag",             {"fg": s:bw80})
call s:h("xmlString",             {"fg": s:yellow})

call s:h("hexDataEven",           {"fg": s:norm, "bg": s:bg})
call s:h("hexDataOdd",            {"fg": s:bwc0, "bg": s:cloud_ddd})

" Signify, git-gutter
hi link SignifySignAdd              LineNr
hi link SignifySignDelete           LineNr
hi link SignifySignChange           LineNr
call s:h("GitGutterAdd"          , {"fg": s:green  , "bg": s:green_house})
call s:h("GitGutterDelete"       , {"fg": s:red    , "bg": s:persian_plum})
call s:h("GitGutterChange"       , {"fg": s:cyan   , "bg": s:mirage})
call s:h("GitGutterChangeDelete" , {"fg": s:red    , "bg": s:kashmir_dd})
