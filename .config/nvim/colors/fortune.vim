...
call s:h("Search",        {"bg": s:bw17, "fg": s:green})
...
call s:h("diffAdded"     , {"fg": s:green  , "bg": s:kashmir})
call s:h("diffRemoved"   , {"fg": s:red    , "bg": s:kashmir})
call s:h("diffFile"      , {"fg": s:yellow , "bg": s:kashmir})
call s:h("diffIndexLine" , {"fg": s:yellow , "bg": s:kashmir})
call s:h("diffLine"      , {"fg": s:cyan   , "bg": s:kashmir})
call s:h("diffSubname"   , {"fg": s:cyan   , "bg": s:kashmir})
